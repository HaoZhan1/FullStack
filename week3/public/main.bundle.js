...
module.exports = "<div>\n  <form #formRef = \"ngForm\">\n    <div class=\"form-group\">\n      <label for=\"problemName\">Problem name</label>\n      <input name = \"problemName\" type=\"text\" required class=\"form-control\" id=\"problemName\" placeholder=\"Please enter problem name\"\n             [(ngModel)] = \"newProblem.name\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"problemDesc\">Problem description</label>\n      <textarea name=\"problemDesc\" class=\"form-control\" id=\"problemDesc\" placeholder=\"Please enter problem description\"\n                [(ngModel)]=\"newProblem.desc\" rows=\"3\">\n        </textarea>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"difficulty\">Difficulty</label>\n      <select name=\"difficulty\" id=\"difficulty\" class=\"form-control\"\n              [(ngModel)]=\"newProblem.difficulty\">\n        <option *ngFor=\"let difficulty of difficulties\" [value]=\"difficulty\">\n          {{difficulty}}\n        </option>\n      </select>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-md-12\">\n        <button type=\"submit\" class=\"btn btn-primary pull-right\"\n                (click)=\"addProblem()\">Add problem</button>\n      </div>\n    </div>\n  </form>\n</div>\n<br/>\n<br/>\n"
...
var core_1 = __webpack_require__("../../../core/esm5/core.js");
var data_service_1 = __webpack_require__("../../../../../src/app/services/data.service.ts");
var DEFALUT_PROBLEM = Object.freeze({
    id: 0,
    name: '',
    desc: '',
    difficulty: 'easy'
...
var ProblemDetailComponent = /** @class */ (function () {
    function ProblemDetailComponent(dataService, activateRoute) {
        this.dataService = dataService;
    ...
    ProblemDetailComponent.prototype.ngOnInit = function () {
        ...
        this.activateRoute.params.subscribe(function (params) {
            ...
            _this.dataService.getProblemById(+params['id'])
...
// module
exports.push([module.i, ".diffidulty {\n  min-width:  100px;\n  margin-right: 10px;\n}\n\n.label.diffidulty{\n  padding-top: 0.6em;\n  color: #fbfdfa;\n  font-size: 12px;\n}\n\n.title{\n  font-size: 1.2em;\n}\n\n.diff-easy{\n  background-color: #42ebf4;\n}\n\n.diff-medium{\n  background-color: #92cf5c;\n}\n\n.diff-hard{\n  background-color: #dd0d1e;\n}\n\n.diff-super{\n  background-color: #8d16e2;\n}\n", ""]);
...
var DataService = /** @class */ (function () {
    function DataService(HttpClient) {
        ...
        this.problemDataService = new BehaviorSubject_1.BehaviorSubject([]);
    }
    ...
    DataService.prototype.getProblems = function () {
        ...
        this.HttpClient.get('api/v1/problems')
            .toPromise()
            .then(function (res) {
            _this.problemDataService.next(res);
        })
